...
function Sell() {
  ...
  const { equivalentBTC } = useAppSelector(
    (state) => state.dashboard.user.payload.walletInfo,
  );
  const checkSee = useAppSelector(
    (state) => state.dashboard.user.payload.walletInfo,
  );
        ...
        if (data[value] <= minimumPurchaseableCryptoAmount) {
          return toast.error(
            'You cant buy less than ' +
              minimumPurchaseableCryptoAmount +
              ' worth of eth',
          );
        }
      }
    ...
    <>
      <div className=" px-8 w-full h-full">
        ...
        <div className="overflow-hidden h-[450px] mt-10 ">
          ...
          >
            <div className="text-[19px] my-8">
              Select wallet to receive with
            </div>
                  ...
                  <div className="w-5/12">
                    ...
                    >
                      <input
                        type="text"
                        className={
                          'w-10/12 h-full bg-transparent outline-none border-0'
                        }
                        placeholder="0.0"
