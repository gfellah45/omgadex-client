        ...
        <Container>
          <div className="flex flex-wrap items-center justify-between flex-1 p-2 md:py-2 lg:py-2">
            <div className="flex items-center lg:w-[60%]  xl:w-[70%] ">
              ...
              {/* the nav bar */}
              <div className="lg:ml-5 xl:ml-10 lg:block">
                <ul className="flex items-center lg:space-x-2 xl:space-x-10">
                  <li className="lg:text-[14px] xl:text-[14px] font-bold text-links font-poppins hover:text-primary ">
                    <Link href="/">
                      <a>Home</a>
                    </Link>
                  </li>
        ...
        <main className="relative">
          ...
          <div className="flex font-sans h-[80vh] md:min-h-[476px] p-4  md:px-28 md:pt-28 flex-wrap bg-pattern bg-no-repeat bg-auto bg-center">
            ...
            <div className="w-full md:w-1/2 md:pt-0 pt-20">
              <p className="md:text-md  font-normal capitalize  text-light_purple">COMING SOON!!</p>
            ...
            <div className="w-full md:w-1/2 hidden md:flex justify-center items-center h-full">
              <Image width="220" height="450" src={rocket} alt="rocket image" className="-z-10" />
            </div>
          </div>
