...
const CryptoWallets: FC<Props> = ({
  ...
  return (
    <div
      className={clsx(
        "shadow-sm rounded-lg px-6 py-5 md:px-10 md:py-8",
    ...
    >
      <div className="flex justify-between items-center">
        <div className="flex space-x-2 items-center">
          ...
          <div>
            ...
            <p className="text-sm font-bold">{cryptoBalance ? cryptoBalance : "0.00"}</p>
          </div>
        </div>
        ...
        <div>
          ...
          <p className="text-gray-500 text-sm">
            {dollarBalance ? formatter("USD").format(Number(dollarBalance)) : "0.00"} USD
          </p>
        </div>
      </div>
      ...
      <div className="mt-16 w-full">
        <div className="w-full ml-auto grid grid-cols-3 gap-4">
          <TransactionButtons action={sendAction} text="Send" icon={<Deposit />} />
          <TransactionButtons action={recieveAction} text="Recieve" icon={<Deposit />} />
