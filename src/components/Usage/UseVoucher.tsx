    ...
    <div className="mt-20 lg:my-32">
      <Container>
        <div>
          ...
          <p className="mt-5 text-center text-links w-8/12 mx-auto">
        ...
        <div className="grid grid-cols-1 mt-10 md:mt-20 md:grid-cols-3">
          {usage.map((item, index) => (
            <UsageCard key={index} text={item.heading} image={item.icon} description={item.text} />
          ))}
        </div>

        <div className="mt-20 md:mt-32">
          <h2 className="text-4xl font-bold text-center w-10/12 mx-auto md:text-4xl">
          ...
          <div className="mx-auto mt-10 text-center ">
            <button className="w-7/12  px-3 py-4 text-white md:px-5 md:py-6 lg:w-2/12 md:4/12 rounded-2xl bg-primary">
              Create Account
            </button>
          </div>
        </div>
