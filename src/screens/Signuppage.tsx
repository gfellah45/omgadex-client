...
const Signuppage = (props: Props): JSX.Element => {
  return (
    <div className="lg:flex">
            ...
            <div className="mt-10 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-36 xl:px-24 xl:max-w-2xl">
                    <h2 className="text-center text-black-800 font-display font-semibold lg:text-left  text-xl md:text-3xl">Sign up to Omega Dex</h2>
                    ...
                    <div className="mt-12">
                        ...
                        <div className="mt-8">
                            ...
                            <div className="mt-8">
                                ...
                                <input className="w-full text-lg py-2 px-2 border rounded-md border-gray-300 focus:outline-none focus:border-indigo-500" type="password" placeholder="Confirm Password" /> 
                            </div>
                            <div className="mt-10">
                        ...
                        <div className="mt-12 font-display font-semibold text-gray-700 text-center text-xs md:text-sm">
                            Already have an account ? <a className="cursor-pointer text-indigo-600 hover:text-indigo-800">Login</a>
                        </div>
                    </div>
                </div>
        </div>
